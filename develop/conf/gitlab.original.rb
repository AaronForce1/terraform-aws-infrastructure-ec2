...
# run: alertmanager: (pid 20748) 549s; run: log: (pid 1940) 66702s
# run: crond: (pid 20763) 549s; run: log: (pid 1943) 66702s
# run: gitaly: (pid 20771) 548s; run: log: (pid 5623) 66495s
run: gitlab-exporter: (pid 22243) 20s; run: log: (pid 22242) 20s
# run: gitlab-workhorse: (pid 20793) 548s; run: log: (pid 1919) 66702s
# run: grafana: (pid 20813) 547s; run: log: (pid 1937) 66702s
# run: logrotate: (pid 20826) 547s; run: log: (pid 1918) 66702s
# run: nginx: (pid 20832) 546s; run: log: (pid 10471) 51867s
# run: node-exporter: (pid 20916) 546s; run: log: (pid 1927) 66702s
# run: postgres-exporter: (pid 20923) 546s; run: log: (pid 1936) 66702s
# run: postgresql: (pid 20930) 545s; run: log: (pid 1938) 66702s
# run: prometheus: (pid 20939) 545s; run: log: (pid 1921) 66702s
# run: redis: (pid 20954) 544s; run: log: (pid 1923) 66702s
# run: redis-exporter: (pid 20959) 544s; run: log: (pid 1926) 66702s
# run: registry: (pid 20967) 543s; run: log: (pid 1944) 66702s
run: sidekiq: (pid 22225) 26s; run: log: (pid 22224) 26s
# run: unicorn: (pid 20978) 543s; run: log: (pid 1933) 66702s

## GitLab URL
##! URL on which GitLab will be reachable.
##! For more details on configuring external_url see:
##! https://docs.gitlab.com/omnibus/settings/configuration.html#configuring-the-external-url-for-gitlab
external_url 'https://git.hk.asiaticketing.com'
...
letsencrypt['contact_emails'] = ['dev@ticketflap.com', 'aaron.baideme@magneticasia.com']
...
gitlab_rails['backup_path'] = "/var/nfs/gitlab-backups"
...
# gitlab_rails['db_username'] = 'gitlab'
# gitlab_rails['db_password'] = 'z9cuZkaarEnaFaEQMy2g2dm8rrVHgrfv'
# gitlab_rails['db_username'] = 'root' 
# gitlab_rails['db_password'] = 'QEFyb25waW9tZWdhNwo=' 
...
registry_external_url 'https://registry.git.hk.asiaticketing.com'

### Settings used by GitLab application
# gitlab_rails['registry_enabled'] = true
# gitlab_rails['registry_host'] = "registry.git.hk.asiaticketing.com"
...
# registry_nginx['redirect_http_to_https_port'] = 443
...
# registry_nginx['ssl_certificate'] = "/etc/gitlab/ssl/registry.gitlab.dev.asiaticketing.com.pem"
# registry_nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/registry.gitlab.dev.asiaticketing.com.key"
# registry_nginx['ssl_client_certificate'] = "/etc/gitlab/ssl/registry.gitlab.dev.asiaticketing.com.crt"
