...
# ok: run: alertmanager: (pid 20748) 0s
# ok: run: crond: (pid 20763) 1s
# ok: run: gitaly: (pid 20771) 0s
# ok: run: gitlab-workhorse: (pid 20793) 1s
# ok: run: grafana: (pid 20813) 0s
# ok: run: logrotate: (pid 20826) 1s
# ok: run: nginx: (pid 20832) 0s
# ok: run: node-exporter: (pid 20916) 0s
# ok: run: postgres-exporter: (pid 20923) 1s
# ok: run: postgresql: (pid 20930) 0s
# ok: run: prometheus: (pid 20939) 1s
# ok: run: redis: (pid 20954) 0s
# ok: run: redis-exporter: (pid 20959) 1s
# ok: run: registry: (pid 20967) 0s
# ok: run: unicorn: (pid 20978) 0s
...
gitlab_rails['uploads_object_store_remote_directory'] = "asiaticketing-gitlab-upload-files"
gitlab_rails['uploads_object_store_connection'] = {
  'provider' => 'AWS',
  'region' => 'ap-southeast-1',
  'aws_access_key_id' => '${AWS_ACCESS_KEY_ID_UPLOADS}',
  'aws_secret_access_key' => '${AWS_SECRET_KEY_UPLOADS}'
#   # # The below options configure an S3 compatible host instead of AWS
#   # 'host' => 's3.amazonaws.com',
#   # 'aws_signature_version' => 4, # For creation of signed URLs. Set to 2 if provider does not support v4.
#   # 'endpoint' => 'https://s3.amazonaws.com', # default: nil - Useful for S3 compliant services such as DigitalOcean Spaces
...
letsencrypt['contact_emails'] = ["aaron.baideme@magneticasia.com", "ronel.cartas@magneticasia.com", "Accounts_Tech_AT@magneticasia.com"] # This should be an array of email addresses to add as contacts
